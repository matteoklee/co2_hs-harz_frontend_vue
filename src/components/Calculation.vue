<template>
  <form @submit.prevent="calculateEmission()" novalidate class="block bg-gray-600 p-4">
    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
      ...
      <div v-if="true" class="col-span-2 flex justify-center lg:flex-row flex-col ">
        ...
        <div v-if="isTransportMediumFuelAvailable()" class="relative lg:w-auto w-full pl-10 mt-2 text-sm text-red-600 dark:text-red-500 relative"> <div v-if="transportMediumFuelInvalid" >Erforderlich (transFuel)</div> </div>
        <div v-if="isTransportMediumSizeAvailable()" class="relative lg:w-auto w-full pl-10 mt-2 text-sm text-red-600 dark:text-red-500 relative"> <div v-if="transportMediumSizeInvalid" >Erforderlich (transSize)</div> </div>
        <div v-if="isTransportMediumFuelConsumptionAvailable()" class="relative pl-10 lg:w-auto w-full mt-2 text-sm text-red-600 dark:text-red-500 relative"> <div v-if="transportMediumFuelConsumptionInvalid" >Muss eine gültige Zahl sein (CustomConsumption) <br/> (z.B. 12345.67)</div> </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      startLocationInvalid: false,
      endLocationInvalid: false,
      transportMediumNameInvalid: false,
      transportMediumFuelInvalid: false,
      transportMediumSizeInvalid: false,
      transportMediumFuelConsumptionInvalid: false,
    }
  },
  methods: {
    resetForm(){
    ...
    validateInput() {
      this.startLocationInvalid = (this.startLocation === '');
      this.endLocationInvalid = (this.endLocation === '');
      this.transportMediumNameInvalid = (this.transportMediumName === 'default');
      this.transportMediumSizeInvalid = (this.isTransportMediumSizeAvailable() && this.transportMediumSize === 'default');
      this.transportMediumFuelInvalid = (this.isTransportMediumFuelAvailable() && this.transportMediumFuel === 'default');
      this.transportMediumFuelConsumptionInvalid = (this.transportMediumCustomConsumption && isNaN(this.transportMediumFuelConsumption) || (this.transportMediumFuelConsumption == 0));
      return !(this.startLocationInvalid || this.endLocationInvalid || this.transportMediumNameInvalid || this.transportMediumFuelConsumptionInvalid || this.transportMediumFuelInvalid || this.transportMediumSizeInvalid);
    },
    resetValidationError(){
      this.startLocationInvalid = false;
      this.endLocationInvalid = false;
      this.transportMediumNameInvalid = false;
      this.transportMediumFuelConsumptionInvalid = false;
      this.transportMediumFuelInvalid = false;
      this.transportMediumSizeInvalid = false;
    },
