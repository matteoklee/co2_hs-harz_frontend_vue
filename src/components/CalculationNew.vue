<template>
  ...
  <form @submit.prevent="calculateEmission()" class="p-4 border shadow max-w-full">
    <!-- ... -->
    <div class="grid gap-4 grid-cols-2">
      <!-- ... -->

      <div class="col-span-2 flex justify-end lg:flex-row flex-col ">
        <!-- <div class="relative w-full sm:w-full pr-2"> -->
      ...
      <div class="col-span-2 flex justify-center lg:flex-row flex-col ">
        <div class="relative w-full sm:w-full pr-2">
          <input v-model="startLocation" type="text" name="startLocation" id="startLocation" class="pl-10 rounded-lg w-full sm:w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-green-600 focus:border-green-600 mb-4 me-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Magdeburg" required="">
          <div class="absolute inset-y-4 start-0 top-0 flex items-center ps-3.5 pt-0 pointer-events-none">
            <i class="fa-solid fa-location-dot"></i>
          </div>
        </div>
        <!-- ... Wiederhole diese Änderungen für die anderen Input-Felder -->

        <div class="relative w-full sm:w-full pr-2">
          <input v-model="endLocation" type="text" name="endLocation" id="endLocation" class="pl-10 rounded-lg w-full sm:w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-green-600 focus:border-green-600 mb-4 me-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Wernigerode" required="">
          <div class="absolute inset-y-4 start-0 top-0 flex items-center ps-3.5 pt-0 pointer-events-none">
            <i class="fa-solid fa-location-dot"></i>
          </div>
        </div>
        ...
        <div class="relative w-full sm:w-full pr-2">
          <select v-model="transportMediumName" :onchange="resetInputs" id="transportMediumName"
                  class="pl-10 rounded-lg w-full sm:w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-green-500 focus:border-green-500 mb-4 me-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
        ...
        <div class="relative w-full sm:w-full pr-2" v-if="isTransportMediumFuelAvailable()">
        ...
        <div class="relative w-full sm:w-full pr-2" v-if="isTransportMediumSizeAvailable()">
        ...
        <div class="relative w-full sm:w-full pr-2" v-if="isTransportMediumFuelConsumptionAvailable()">
          <input v-model="transportMediumFuelConsumption" type="text" name="consumption" id="consumption"
                 class="pl-10 rounded-lg w-full sm:w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-green-600 focus:border-green-600 mb-4 me-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="7.2" required="">
          <div class="absolute inset-y-4 start-0 top-0 flex items-center ps-3.5 pt-0 pointer-events-none">
